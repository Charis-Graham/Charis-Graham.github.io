...
Since then, I’ve taken a linguistic or machine learning-related class every semester, diving deeper into how statistics and machine learning can be used to model language. My interest has grown even further to encompass the full breadth of machine learning. I’ve been especially drawn to the transformative potential of large language models (LLMs) across a variety of fields, from linguistics to astronomy. Two summers ago, I interned on a project studying emergent languages—researching how models can create their own languages to communicate. Last summer, I interned at the Harvard and Smithsonian Center for Astrophysics, working with the AstroAI consortium to improve a supernovae classifier for the launch of the Vera Rubin telescope. These experiences solidified my desire to focus on machine learning and natural language processing in my future career. 
